              ...
              $(".navbar").addClass("navbar-cases-background")
                ...
                if (producto.categoria == "ilustraciones") {
                  ...
                  $(".navbar").addClass("navbar-deco-background")
                    ...
                    divTemplate = divTemplateDeco
                    $(".navbar").addClass("navbar-deco-background")
                      }else { if (producto.subcategoria == "biodegradable") {
            ...
            <div class="col products__list__item--description">
              <div class="card border-0" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <h6 class="card-subtitle mb-3">$${producto.precio}Ars</h6>

                  ${divTemplate}

                <a href="https://api.whatsapp.com/send?phone=541169957849"><button type="button" class="btn mt-3 btn-whatsapp justify-content-center">Pedilo por Whatsapp <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp ms-1" viewBox="0 0 16 16">
